...
import hctaEpc.mmeSgsn.System;

/**
 * This class represents an element from 
 * the namespace http://hitachi-cta.com/ns/epc
 * generated to "src/hctaEpc/mme-sgsn"
 * <p>
 * See line 64 in
 * mmeSgsnConfig.yang
 *
 ...
 */
public class MmeSgsn extends YangElement {
    ...
    /**
     * Field for child container "subscriber".
     */
    ...
    /**
     * Field for child container "imsi-routing".
     */
    public ImsiRouting imsiRouting = null;

    /**
     * Field for child container "csl".
     */
    public Csl csl = null;
    ...
    /**
     * Constructor for an empty MmeSgsn object.
     */
    public MmeSgsn() {
        super(Epc.NAMESPACE, "mme-sgsn");
        setDefaultPrefix();
     ...
     */
    public MmeSgsn clone() {
        return (MmeSgsn)cloneContent(new MmeSgsn());
    }
     ...
     */
    public MmeSgsn cloneShallow() {
        return (MmeSgsn)cloneShallowContent(new MmeSgsn());
    }
    ...
    /* Access methods for container child: "subscriber". */

    /**
     * Adds container entry "subscriber", using an existing object.
    ...
    /**
     * Adds container entry "subscriber".
     * This method is used for creating subtree filters.
     * @return The added child.
     */
    ...
    /**
     * Deletes container entry "subscriber".
     * @return An array of the deleted element nodes.
     */
    public NodeSet deleteSubscriber() throws JNCException {
    ...
    /* Access methods for optional leaf child: "summary". */

    /**
     * Gets the value for child leaf "summary".
     * @return The value of the leaf.
     */
    public YangString getSummaryValue() throws JNCException {
        return (YangString)getValue("summary");
    }

    /**
     * Sets the value for child leaf "summary",
     * using instance of generated typedef class.
     * @param summaryValue The value to set.
     * @param summaryValue used during instantiation.
     */
    public void setSummaryValue(YangString summaryValue) throws JNCException {
        setLeafValue(Epc.NAMESPACE,
            "summary",
            summaryValue,
            childrenNames());
     ...
     * @param summaryValue used during instantiation.
     */
    public void setSummaryValue(String summaryValue) throws JNCException {
        setSummaryValue(new YangString(summaryValue));
    }

    /**
     * Unsets the value for child leaf "summary".
     */
    public void unsetSummaryValue() throws JNCException {
        delete("summary");
    }

    /**
     * This method is used for creating a subtree filter.
     * The added "summary" leaf will not have a value.
     */
    public void addSummary() throws JNCException {
        setLeafValue(Epc.NAMESPACE,
            "summary",
            null,
            childrenNames());
    ...
    /**
     * Marks the leaf "summary" with operation "replace".
     */
    public void markSummaryReplace() throws JNCException {
        markLeafReplace("summary");
    }

    /**
     * Marks the leaf "summary" with operation "merge".
     */
    public void markSummaryMerge() throws JNCException {
        markLeafMerge("summary");
    }

    /**
     * Marks the leaf "summary" with operation "create".
     */
    public void markSummaryCreate() throws JNCException {
        markLeafCreate("summary");
    }

    /**
     * Marks the leaf "summary" with operation "delete".
     */
    public void markSummaryDelete() throws JNCException {
        markLeafDelete("summary");
    }
    ...
    /* Access methods for container child: "imsi-routing". */

    /**
     * Adds container entry "imsiRouting", using an existing object.
     * @param imsiRouting The object to add.
     * @return The added child.
     */
    public ImsiRouting addImsiRouting(ImsiRouting imsiRouting)
            throws JNCException {
        this.imsiRouting = imsiRouting;
        insertChild(imsiRouting, childrenNames());
        return imsiRouting;
    }

    /**
     * Adds container entry "imsiRouting".
     * This method is used for creating subtree filters.
     * @return The added child.
     */
    public ImsiRouting addImsiRouting() throws JNCException {
        ImsiRouting imsiRouting = new ImsiRouting();
        this.imsiRouting = imsiRouting;
        insertChild(imsiRouting, childrenNames());
        return imsiRouting;
    }
    ...
    /**
     * Deletes container entry "imsiRouting".
     * @return An array of the deleted element nodes.
     */
    public NodeSet deleteImsiRouting() throws JNCException {
        this.imsiRouting = null;
        String path = "imsi-routing";
        return delete(path);
    }

    /* Access methods for container child: "csl". */

    /**
     * Adds container entry "csl", using an existing object.
     * @param csl The object to add.
     * @return The added child.
     */
    public Csl addCsl(Csl csl) throws JNCException {
        this.csl = csl;
        insertChild(csl, childrenNames());
        return csl;
    }

    /**
     * Adds container entry "csl".
     * This method is used for creating subtree filters.
     * @return The added child.
     */
    public Csl addCsl() throws JNCException {
        Csl csl = new Csl();
        this.csl = csl;
        insertChild(csl, childrenNames());
        return csl;
    ...
    /**
     * Deletes container entry "csl".
     * @return An array of the deleted element nodes.
     */
    public NodeSet deleteCsl() throws JNCException {
        this.csl = null;
        String path = "csl";
        return delete(path);
    }
    ...
    public void addChild(Element child) {
        ...
        else if (child instanceof Subscriber) subscriber = (Subscriber)child;
        ...
        else if (child instanceof ImsiRouting) imsiRouting = (ImsiRouting)child;
        else if (child instanceof Csl) csl = (Csl)child;
