 ...
 * generated to "src/hctaEpc/fgw/interface_/s1/enb"
 * <p>
 * See line 173 in
 * s1MasterCli.yang
 *
...
public class Enb extends YangElement {
    ...
    /* Access methods for optional leaf child: "process-location". */

    /**
     * Gets the value for child leaf "process-location".
     * @return The value of the leaf.
     */
    public YangString getProcessLocationValue() throws JNCException {
        return (YangString)getValue("process-location");
    }

    /**
     * Sets the value for child leaf "process-location",
     * using instance of generated typedef class.
     * @param processLocationValue The value to set.
     * @param processLocationValue used during instantiation.
     */
    public void setProcessLocationValue(YangString processLocationValue)
            throws JNCException {
        setLeafValue(Epc.NAMESPACE,
            "process-location",
            processLocationValue,
            childrenNames());
    }
     ...
     * @param processLocationValue used during instantiation.
     */
    public void setProcessLocationValue(String processLocationValue)
            throws JNCException {
        setProcessLocationValue(new YangString(processLocationValue));
    }

    /**
     * Unsets the value for child leaf "process-location".
     */
    public void unsetProcessLocationValue() throws JNCException {
        delete("process-location");
    }

    /**
     * This method is used for creating a subtree filter.
     * The added "process-location" leaf will not have a value.
     */
    public void addProcessLocation() throws JNCException {
        setLeafValue(Epc.NAMESPACE,
            "process-location",
            null,
            childrenNames());
    ...
    /**
     * Marks the leaf "process-location" with operation "replace".
     */
    public void markProcessLocationReplace() throws JNCException {
        markLeafReplace("processLocation");
    }

    /**
     * Marks the leaf "process-location" with operation "merge".
     */
    public void markProcessLocationMerge() throws JNCException {
        markLeafMerge("processLocation");
    }

    /**
     * Marks the leaf "process-location" with operation "create".
     */
    public void markProcessLocationCreate() throws JNCException {
        markLeafCreate("processLocation");
    }

    /**
     * Marks the leaf "process-location" with operation "delete".
     */
    public void markProcessLocationDelete() throws JNCException {
        markLeafDelete("processLocation");
    }

    /* Access methods for optional leaf child: "etrace-app-name". */

    /**
     * Gets the value for child leaf "etrace-app-name".
     * @return The value of the leaf.
     */
    public YangString getEtraceAppNameValue() throws JNCException {
        return (YangString)getValue("etrace-app-name");
    }

    /**
     * Sets the value for child leaf "etrace-app-name",
     * using instance of generated typedef class.
     * @param etraceAppNameValue The value to set.
     * @param etraceAppNameValue used during instantiation.
     */
    public void setEtraceAppNameValue(YangString etraceAppNameValue)
            throws JNCException {
        setLeafValue(Epc.NAMESPACE,
            "etrace-app-name",
            etraceAppNameValue,
     ...
     * @param etraceAppNameValue used during instantiation.
     */
    public void setEtraceAppNameValue(String etraceAppNameValue)
            throws JNCException {
        setEtraceAppNameValue(new YangString(etraceAppNameValue));
    }

    /**
     * Unsets the value for child leaf "etrace-app-name".
     */
    public void unsetEtraceAppNameValue() throws JNCException {
        delete("etrace-app-name");
    }

    /**
     * This method is used for creating a subtree filter.
     * The added "etrace-app-name" leaf will not have a value.
     */
    public void addEtraceAppName() throws JNCException {
        setLeafValue(Epc.NAMESPACE,
            "etrace-app-name",
            null,
            childrenNames());
    ...
    /**
     * Marks the leaf "etrace-app-name" with operation "replace".
     */
    public void markEtraceAppNameReplace() throws JNCException {
        markLeafReplace("etraceAppName");
    }

    /**
     * Marks the leaf "etrace-app-name" with operation "merge".
     */
    public void markEtraceAppNameMerge() throws JNCException {
        markLeafMerge("etraceAppName");
    }

    /**
     * Marks the leaf "etrace-app-name" with operation "create".
     */
    public void markEtraceAppNameCreate() throws JNCException {
        markLeafCreate("etraceAppName");
    }

    /**
     * Marks the leaf "etrace-app-name" with operation "delete".
     */
    public void markEtraceAppNameDelete() throws JNCException {
        markLeafDelete("etraceAppName");
    }
     ...
     * @return The value of the leaf.
     */
    public YangBoolean getOverloadStartSentValue() throws JNCException {
        return (YangBoolean)getValue("overload-start-sent");
    }
     ...
     */
    public void setOverloadStartSentValue(YangBoolean overloadStartSentValue)
            throws JNCException {
        setLeafValue(Epc.NAMESPACE,
            "overload-start-sent",
     ...
     * @param overloadStartSentValue used during instantiation.
     */
    public void setOverloadStartSentValue(Boolean overloadStartSentValue)
            throws JNCException {
        setOverloadStartSentValue(new YangBoolean(overloadStartSentValue));
    }
