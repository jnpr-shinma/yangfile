 ...
 * generated to "src/hctaEpc/fgw/statistics/fgwBm/eRabRelease"
 * <p>
 * See line 2417 in
 * oamPmServerCli.yang
 *
 ...
 */
public class ERabRelease extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty ERabRelease object.
     */
    public ERabRelease() {
        super(Epc.NAMESPACE, "eRabRelease");
    }
     ...
     */
    public ERabRelease clone() {
        return (ERabRelease)cloneContent(new ERabRelease());
    }
     ...
     */
    public ERabRelease cloneShallow() {
        return (ERabRelease)cloneShallowContent(new ERabRelease());
    }
