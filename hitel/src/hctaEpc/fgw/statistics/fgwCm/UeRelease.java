 ...
 * generated to "src/hctaEpc/fgw/statistics/fgwCm/ueRelease"
 * <p>
 * See line 2488 in
 * oamPmServerCli.yang
 *
 ...
 */
public class UeRelease extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty UeRelease object.
     */
    public UeRelease() {
        super(Epc.NAMESPACE, "ueRelease");
    }
     ...
     */
    public UeRelease clone() {
        return (UeRelease)cloneContent(new UeRelease());
    }
     ...
     */
    public UeRelease cloneShallow() {
        return (UeRelease)cloneShallowContent(new UeRelease());
    }
