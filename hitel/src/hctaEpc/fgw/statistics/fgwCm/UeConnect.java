 ...
 * generated to "src/hctaEpc/fgw/statistics/fgwCm/ueConnect"
 * <p>
 * See line 2475 in
 * oamPmServerCli.yang
 *
 ...
 */
public class UeConnect extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty UeConnect object.
     */
    public UeConnect() {
        super(Epc.NAMESPACE, "ueConnect");
    }
     ...
     */
    public UeConnect clone() {
        return (UeConnect)cloneContent(new UeConnect());
    }
     ...
     */
    public UeConnect cloneShallow() {
        return (UeConnect)cloneShallowContent(new UeConnect());
    }
