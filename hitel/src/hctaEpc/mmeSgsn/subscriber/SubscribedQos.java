/* 
 * @(#)SubscribedQos.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/subscriber/subscribed-qos"
 * <p>
 * See line 1339 in
 * scCli.yang
 *
 ...
 */
public class SubscribedQos extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty SubscribedQos object.
     */
    public SubscribedQos() {
        super(Epc.NAMESPACE, "subscribed-qos");
    }
     ...
     */
    public SubscribedQos clone() {
        return (SubscribedQos)cloneContent(new SubscribedQos());
    }
     ...
     */
    public SubscribedQos cloneShallow() {
        return (SubscribedQos)cloneShallowContent(new SubscribedQos());
    }
