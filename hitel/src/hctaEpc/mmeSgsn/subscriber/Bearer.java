 ...
 * generated to "src/hctaEpc/mmeSgsn/subscriber/bearer"
 * <p>
 * See line 1378 in
 * scCli.yang
 *
 ...
 */
public class Bearer extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Bearer object.
     */
    public Bearer() {
        super(Epc.NAMESPACE, "bearer");
    }
     ...
     */
    public Bearer clone() {
        return (Bearer)cloneContent(new Bearer());
    }
     ...
     */
    public Bearer cloneShallow() {
        return (Bearer)cloneShallowContent(new Bearer());
    }
