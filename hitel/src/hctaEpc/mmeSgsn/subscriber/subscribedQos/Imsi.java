 ...
 * generated to "src/hctaEpc/mmeSgsn/subscriber/subscribedQos/imsi"
 * <p>
 * See line 1341 in
 * scCli.yang
 *
...
public class Imsi extends YangElement {
    ...
    /* Access methods for leaf child: "subscription-context-id". */

    /**
     * Gets the value for child leaf "subscription-context-id".
     * @return The value of the leaf.
     */
    public YangUInt32 getSubscriptionContextIdValue() throws JNCException {
        return (YangUInt32)getValue("subscription-context-id");
    }

    /**
     * Sets the value for child leaf "subscription-context-id",
     * using instance of generated typedef class.
     * @param subscriptionContextIdValue The value to set.
     * @param subscriptionContextIdValue used during instantiation.
     */
    public void setSubscriptionContextIdValue(YangUInt32 subscriptionContextIdValue)
            throws JNCException {
        setLeafValue(Epc.NAMESPACE,
            "subscription-context-id",
            subscriptionContextIdValue,
            childrenNames());
    }
     ...
     * @param subscriptionContextIdValue used during instantiation.
     */
    public void setSubscriptionContextIdValue(long subscriptionContextIdValue)
            throws JNCException {
        setSubscriptionContextIdValue(new YangUInt32(subscriptionContextIdValue));
    }
     ...
     * @param subscriptionContextIdValue used during instantiation.
     */
    public void setSubscriptionContextIdValue(String subscriptionContextIdValue)
            throws JNCException {
        setSubscriptionContextIdValue(new YangUInt32(subscriptionContextIdValue));
    }
    ...
    /**
     * This method is used for creating a subtree filter.
     * The added "subscription-context-id" leaf will not have a value.
     */
    public void addSubscriptionContextId() throws JNCException {
        setLeafValue(Epc.NAMESPACE,
            "subscription-context-id",
            null,
            childrenNames());
