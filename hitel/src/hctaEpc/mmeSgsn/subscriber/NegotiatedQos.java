/* 
 * @(#)NegotiatedQos.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/subscriber/negotiated-qos"
 * <p>
 * See line 1300 in
 * scCli.yang
 *
 ...
 */
public class NegotiatedQos extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty NegotiatedQos object.
     */
    public NegotiatedQos() {
        super(Epc.NAMESPACE, "negotiated-qos");
    }
     ...
     */
    public NegotiatedQos clone() {
        return (NegotiatedQos)cloneContent(new NegotiatedQos());
    }
     ...
     */
    public NegotiatedQos cloneShallow() {
        return (NegotiatedQos)cloneShallowContent(new NegotiatedQos());
    }
