/* 
 * @(#)AgwDnsServer.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/dns/agw-dns-server"
 * <p>
 * See line 25 in
 ...
 */
public class AgwDnsServer extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty AgwDnsServer object.
     */
    public AgwDnsServer() {
        super(Epc.NAMESPACE, "agw-dns-server");
    }

    /**
     * Constructor for an initialized AgwDnsServer object,
     * 
     * @param serverNameValue Key argument of child.
     */
    public AgwDnsServer(YangString serverNameValue) throws JNCException {
        super(Epc.NAMESPACE, "agw-dns-server");
        Leaf serverName = new Leaf(Epc.NAMESPACE, "server-name");
        serverName.setValue(serverNameValue);
        insertChild(serverName, childrenNames());
    }
     ...
     * @param serverNameValue Key argument of child.
     */
    public AgwDnsServer(String serverNameValue) throws JNCException {
        super(Epc.NAMESPACE, "agw-dns-server");
        Leaf serverName = new Leaf(Epc.NAMESPACE, "server-name");
        serverName.setValue(new YangString(serverNameValue));
        insertChild(serverName, childrenNames());
    }
     ...
     */
    public AgwDnsServer clone() {
        AgwDnsServer copy;
        try {
            copy = new AgwDnsServer(getServerNameValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (AgwDnsServer)cloneContent(copy);
    }
     ...
     */
    public AgwDnsServer cloneShallow() {
        AgwDnsServer copy;
        try {
            copy = new AgwDnsServer(getServerNameValue().toString());
        } catch (JNCException e) {
        ...
        return (AgwDnsServer)cloneShallowContent(copy);
    }
    ...
    /* Access methods for leaf child: "server-name". */
    ...
    public YangUInt16 getWeightValue() throws JNCException {
        ...
        if (weight == null) {
            weight = new YangUInt16("10");  // default
        }
        return weight;
    }
