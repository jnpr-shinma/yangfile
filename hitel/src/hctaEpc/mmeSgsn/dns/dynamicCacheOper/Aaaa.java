 ...
 * generated to "src/hctaEpc/mmeSgsn/dns/dynamicCacheOper/aaaa"
 * <p>
 * See line 127 in
 * agwCmnDnsCli.yang
 *
 ...
 */
public class Aaaa extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Aaaa object.
     */
    public Aaaa() {
        super(Epc.NAMESPACE, "aaaa");
    }
     ...
     */
    public Aaaa clone() {
        return (Aaaa)cloneContent(new Aaaa());
    }
     ...
     */
    public Aaaa cloneShallow() {
        return (Aaaa)cloneShallowContent(new Aaaa());
    }
