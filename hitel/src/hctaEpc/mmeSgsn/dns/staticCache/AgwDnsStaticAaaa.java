/* 
 * @(#)AgwDnsStaticAaaa.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/dns/staticCache/agw-dns-static-aaaa"
 * <p>
 * See line 82 in
 ...
 */
public class AgwDnsStaticAaaa extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty AgwDnsStaticAaaa object.
     */
    public AgwDnsStaticAaaa() {
        super(Epc.NAMESPACE, "agw-dns-static-aaaa");
    }

    /**
     * Constructor for an initialized AgwDnsStaticAaaa object,
     * 
     * @param entryIndexValue Key argument of child.
     */
    public AgwDnsStaticAaaa(YangUInt16 entryIndexValue) throws JNCException {
        super(Epc.NAMESPACE, "agw-dns-static-aaaa");
     ...
     * @param entryIndexValue Key argument of child.
     */
    public AgwDnsStaticAaaa(String entryIndexValue) throws JNCException {
        super(Epc.NAMESPACE, "agw-dns-static-aaaa");
        Leaf entryIndex = new Leaf(Epc.NAMESPACE, "entry-index");
     ...
     * @param entryIndexValue Key argument of child.
     */
    public AgwDnsStaticAaaa(int entryIndexValue) throws JNCException {
        super(Epc.NAMESPACE, "agw-dns-static-aaaa");
        Leaf entryIndex = new Leaf(Epc.NAMESPACE, "entry-index");
        entryIndex.setValue(new YangUInt16(entryIndexValue));
        insertChild(entryIndex, childrenNames());
     ...
     */
    public AgwDnsStaticAaaa clone() {
        AgwDnsStaticAaaa copy;
        try {
            copy = new AgwDnsStaticAaaa(getEntryIndexValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (AgwDnsStaticAaaa)cloneContent(copy);
    }
     ...
     */
    public AgwDnsStaticAaaa cloneShallow() {
        AgwDnsStaticAaaa copy;
        try {
            copy = new AgwDnsStaticAaaa(getEntryIndexValue().toString());
        } catch (JNCException e) {
        ...
        return (AgwDnsStaticAaaa)cloneShallowContent(copy);
    }
     ...
     * @return The value of the leaf.
     */
    public Ipv6Address getNodeIpAddressValue() throws JNCException {
        return (Ipv6Address)getValue("node-ip-address");
    }
     ...
     */
    public void setNodeIpAddressValue(Ipv6Address nodeIpAddressValue)
            throws JNCException {
        setLeafValue(Epc.NAMESPACE,
            "node-ip-address",
            nodeIpAddressValue,
    ...
    public void setNodeIpAddressValue(String nodeIpAddressValue)
            throws JNCException {
        setNodeIpAddressValue(new Ipv6Address(nodeIpAddressValue));
    }
