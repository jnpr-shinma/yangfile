 ...
 * generated to "src/hctaEpc/mmeSgsn/interface_/sls/mme-e-smlc"
 * <p>
 * See line 95 in
 * slsConfig.yang
 *
 ...
 */
public class MmeESmlc extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty MmeESmlc object.
     */
    public MmeESmlc() {
        super(Epc.NAMESPACE, "mme-e-smlc");
    }

    /**
     * Constructor for an initialized MmeESmlc object,
     * 
     * @param eSmlcIdValue Key argument of child.
     */
    public MmeESmlc(YangUInt8 eSmlcIdValue) throws JNCException {
        super(Epc.NAMESPACE, "mme-e-smlc");
        Leaf eSmlcId = new Leaf(Epc.NAMESPACE, "e-smlc-id");
        eSmlcId.setValue(eSmlcIdValue);
        insertChild(eSmlcId, childrenNames());
    }
     ...
     * @param eSmlcIdValue Key argument of child.
     */
    public MmeESmlc(String eSmlcIdValue) throws JNCException {
        super(Epc.NAMESPACE, "mme-e-smlc");
        Leaf eSmlcId = new Leaf(Epc.NAMESPACE, "e-smlc-id");
        eSmlcId.setValue(new YangUInt8(eSmlcIdValue));
        insertChild(eSmlcId, childrenNames());
    }
     ...
     * @param eSmlcIdValue Key argument of child.
     */
    public MmeESmlc(short eSmlcIdValue) throws JNCException {
        super(Epc.NAMESPACE, "mme-e-smlc");
        Leaf eSmlcId = new Leaf(Epc.NAMESPACE, "e-smlc-id");
        eSmlcId.setValue(new YangUInt8(eSmlcIdValue));
        insertChild(eSmlcId, childrenNames());
     ...
     */
    public MmeESmlc clone() {
        MmeESmlc copy;
        try {
            copy = new MmeESmlc(getESmlcIdValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (MmeESmlc)cloneContent(copy);
    }
    ...
    public MmeESmlc cloneShallow() {
        ...
        return (MmeESmlc)cloneShallowContent(copy);
    }
    ...
    /* Access methods for leaf child: "e-smlc-id". */

    /**
     * Gets the value for child leaf "e-smlc-id".
     * @return The value of the leaf.
     */
    public YangUInt8 getESmlcIdValue() throws JNCException {
        return (YangUInt8)getValue("e-smlc-id");
    }
     ...
     */
    public void setESmlcIdValue(YangUInt8 eSmlcIdValue) throws JNCException {
     ...
     * @param eSmlcIdValue used during instantiation.
     */
    public void setESmlcIdValue(short eSmlcIdValue) throws JNCException {
        setESmlcIdValue(new YangUInt8(eSmlcIdValue));
    }
