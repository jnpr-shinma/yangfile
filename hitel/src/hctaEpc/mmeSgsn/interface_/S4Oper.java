 ...
 * generated to "src/hctaEpc/mmeSgsn/interface_/s4-oper"
 * <p>
 * See line 459 in
 * upmCli.yang
 *
 ...
 */
public class S4Oper extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty S4Oper object.
     */
    public S4Oper() {
        super(Epc.NAMESPACE, "s4-oper");
    }
     ...
     */
    public S4Oper clone() {
        return (S4Oper)cloneContent(new S4Oper());
    }
     ...
     */
    public S4Oper cloneShallow() {
        return (S4Oper)cloneShallowContent(new S4Oper());
    }
