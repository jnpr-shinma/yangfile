 ...
 * generated to "src/hctaEpc/mmeSgsn/interface_/iu/mme-rnc"
 * <p>
 * See line 250 in
 * rncConfig.yang
 *
 ...
 */
public class MmeRnc extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty MmeRnc object.
     */
    public MmeRnc() {
        super(Epc.NAMESPACE, "mme-rnc");
    }

    /**
     * Constructor for an initialized MmeRnc object,
     * 
     * @param rncIdValue Key argument of child.
     */
    public MmeRnc(YangUInt16 rncIdValue) throws JNCException {
        super(Epc.NAMESPACE, "mme-rnc");
     ...
     * @param rncIdValue Key argument of child.
     */
    public MmeRnc(String rncIdValue) throws JNCException {
        super(Epc.NAMESPACE, "mme-rnc");
        Leaf rncId = new Leaf(Epc.NAMESPACE, "rnc-id");
     ...
     * @param rncIdValue Key argument of child.
     */
    public MmeRnc(int rncIdValue) throws JNCException {
        super(Epc.NAMESPACE, "mme-rnc");
        Leaf rncId = new Leaf(Epc.NAMESPACE, "rnc-id");
        rncId.setValue(new YangUInt16(rncIdValue));
        insertChild(rncId, childrenNames());
    ...
    public MmeRnc clone() {
        MmeRnc copy;
        try {
            copy = new MmeRnc(getRncIdValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (MmeRnc)cloneContent(copy);
    }
    ...
    public MmeRnc cloneShallow() {
        ...
        return (MmeRnc)cloneShallowContent(copy);
    }
    ...
    public YangUInt32 getMaxIuConnectionsValue() throws JNCException {
        ...
        if (maxIuConnections == null) {
            maxIuConnections = new YangUInt32("1000");  // default
        }
