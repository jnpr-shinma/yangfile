/* 
 * @(#)MmeIuCongestionControl.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/engineering/mme-iu-congestion-control"
 * <p>
 * See line 305 in
 * rncConfig.yang
 *
 ...
 */
public class MmeIuCongestionControl extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty MmeIuCongestionControl object.
     */
    public MmeIuCongestionControl() {
        super(Epc.NAMESPACE, "mme-iu-congestion-control");
    }
     ...
     */
    public MmeIuCongestionControl clone() {
     ...
     */
    public MmeIuCongestionControl cloneShallow() {
        return (MmeIuCongestionControl)cloneShallowContent(new MmeIuCongestionControl());
    }
    ...
    public YangEnumeration getMinorActionValue() throws JNCException {
        ...
        if (minorAction == null) {
            minorAction = new YangEnumeration("ignore", new String[] {  // default
                "none",
                "reject",
                "ignore",
            });
    ...
    public YangEnumeration getMajorActionValue() throws JNCException {
        ...
        if (majorAction == null) {
            majorAction = new YangEnumeration("ignore", new String[] {  // default
                "none",
                "reject",
                "ignore",
            });
