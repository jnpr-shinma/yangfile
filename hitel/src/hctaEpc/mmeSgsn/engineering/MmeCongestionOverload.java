/* 
 * @(#)MmeCongestionOverload.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/engineering/mme-congestion-overload"
 * <p>
 * See line 1147 in
 * scConfig.yang
 *
 ...
 */
public class MmeCongestionOverload extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty MmeCongestionOverload object.
     */
    public MmeCongestionOverload() {
        super(Epc.NAMESPACE, "mme-congestion-overload");
    }
     ...
     */
    public MmeCongestionOverload clone() {
        return (MmeCongestionOverload)cloneContent(new MmeCongestionOverload());
    }
     ...
     */
    public MmeCongestionOverload cloneShallow() {
        return (MmeCongestionOverload)cloneShallowContent(new MmeCongestionOverload());
    }
    ...
    public YangEnumeration getMinorActionValue() throws JNCException {
        ...
        if (minorAction == null) {
            minorAction = new YangEnumeration("ignore-attach", new String[] {  // default
                "none",
                "ignore-attach",
                "ignore-itau-irau",
                "reject-roamer-s1-inc-ho",
                "reject-all-s1-inc-ho",
            });
        }
        return minorAction;
    }
    ...
    public YangEnumeration getMajorActionValue() throws JNCException {
        ...
        if (majorAction == null) {
            majorAction = new YangEnumeration("ignore-itau-irau", new String[] {  // default
                "none",
                "ignore-attach",
                "ignore-itau-irau",
                "reject-roamer-s1-inc-ho",
    ...
    public YangEnumeration getCriticalActionValue() throws JNCException {
        ...
        if (criticalAction == null) {
            criticalAction = new YangEnumeration("reject-roamer-s1-inc-ho", new String[] {  // default
                "none",
                "ignore-attach",
                "ignore-itau-irau",
                "reject-roamer-s1-inc-ho",
