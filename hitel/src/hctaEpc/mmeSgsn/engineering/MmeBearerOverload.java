/* 
 * @(#)MmeBearerOverload.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/engineering/mme-bearer-overload"
 * <p>
 * See line 1472 in
 * scConfig.yang
 *
 ...
 */
public class MmeBearerOverload extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty MmeBearerOverload object.
     */
    public MmeBearerOverload() {
        super(Epc.NAMESPACE, "mme-bearer-overload");
    }
     ...
     */
    public MmeBearerOverload clone() {
        return (MmeBearerOverload)cloneContent(new MmeBearerOverload());
    }
     ...
     */
    public MmeBearerOverload cloneShallow() {
        return (MmeBearerOverload)cloneShallowContent(new MmeBearerOverload());
    }
    ...
    public YangEnumeration getCriticalActionValue() throws JNCException {
        ...
        if (criticalAction == null) {
            criticalAction = new YangEnumeration("reject-bearer-setup", new String[] {  // default
                "none",
                "reject-pdn-conn",
                "reject-roamer-attach",
                "reject-roamer-itau-irau",
