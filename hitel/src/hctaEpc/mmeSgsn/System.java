 ...
 * generated to "src/hctaEpc/mmeSgsn/system"
 * <p>
 * See line 109 in
 * mmeSgsnConfig.yang
 *
...
public class System extends YangElement {
    ...
    /**
     * Field for child container "data".
     */
    public Data data = null;

    /**
     * Field for child container "sig".
     */
    public Sig sig = null;
    ...
    /* Access methods for container child: "data". */

    /**
     * Adds container entry "data", using an existing object.
     * @param data The object to add.
     * @return The added child.
     */
    public Data addData(Data data) throws JNCException {
        this.data = data;
        insertChild(data, childrenNames());
        return data;
    }

    /**
     * Adds container entry "data".
     * This method is used for creating subtree filters.
     * @return The added child.
     */
    public Data addData() throws JNCException {
        Data data = new Data();
        this.data = data;
        insertChild(data, childrenNames());
        return data;
    ...
    /**
     * Deletes container entry "data".
     * @return An array of the deleted element nodes.
     */
    public NodeSet deleteData() throws JNCException {
        this.data = null;
        String path = "data";
        return delete(path);
    }

    /* Access methods for container child: "sig". */

    /**
     * Adds container entry "sig", using an existing object.
     * @param sig The object to add.
     * @return The added child.
     */
    public Sig addSig(Sig sig) throws JNCException {
        this.sig = sig;
        insertChild(sig, childrenNames());
        return sig;
    }

    /**
     * Adds container entry "sig".
     * This method is used for creating subtree filters.
     * @return The added child.
     */
    public Sig addSig() throws JNCException {
        Sig sig = new Sig();
        this.sig = sig;
        insertChild(sig, childrenNames());
        return sig;
    ...
    /**
     * Deletes container entry "sig".
     * @return An array of the deleted element nodes.
     */
    public NodeSet deleteSig() throws JNCException {
        this.sig = null;
        String path = "sig";
        return delete(path);
    }
    ...
    /* Access methods for container child: "rm". */

    /**
     * Adds container entry "rm", using an existing object.
     * @param rm The object to add.
     * @return The added child.
     */
    public Rm addRm(Rm rm) throws JNCException {
        this.rm = rm;
        insertChild(rm, childrenNames());
        return rm;
    }

    /**
     * Adds container entry "rm".
     * This method is used for creating subtree filters.
     * @return The added child.
     */
    public Rm addRm() throws JNCException {
        Rm rm = new Rm();
        this.rm = rm;
        insertChild(rm, childrenNames());
        return rm;
    ...
    /**
     * Deletes container entry "rm".
     * @return An array of the deleted element nodes.
     */
    public NodeSet deleteRm() throws JNCException {
        this.rm = null;
        String path = "rm";
        return delete(path);
    }
    ...
    public void addChild(Element child) {
        ...
        else if (child instanceof Data) data = (Data)child;
        else if (child instanceof Sig) sig = (Sig)child;
        else if (child instanceof Lb) lb = (Lb)child;
        else if (child instanceof Rm) rm = (Rm)child;
    }
