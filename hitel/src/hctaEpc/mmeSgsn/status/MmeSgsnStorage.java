/* 
 * @(#)MmeSgsnStorage.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/status/mme-sgsn-storage"
 * <p>
 * See line 45 in
 ...
 */
public class MmeSgsnStorage extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty MmeSgsnStorage object.
     */
    public MmeSgsnStorage() {
        super(Epc.NAMESPACE, "mme-sgsn-storage");
    }
     ...
     */
    public MmeSgsnStorage clone() {
        return (MmeSgsnStorage)cloneContent(new MmeSgsnStorage());
    }
     ...
     */
    public MmeSgsnStorage cloneShallow() {
        return (MmeSgsnStorage)cloneShallowContent(new MmeSgsnStorage());
    }
