 ...
 * generated to "src/hctaEpc/mmeSgsn/status/umts"
 * <p>
 * See line 116 in
 * sgsnScCli.yang
 *
 ...
 */
public class Umts extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Umts object.
     */
    public Umts() {
        super(Epc.NAMESPACE, "umts");
    }
     ...
     */
    public Umts clone() {
        return (Umts)cloneContent(new Umts());
    }
     ...
     */
    public Umts cloneShallow() {
        return (Umts)cloneShallowContent(new Umts());
    }
