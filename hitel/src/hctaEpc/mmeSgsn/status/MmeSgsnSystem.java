/* 
 * @(#)MmeSgsnSystem.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/status/mme-sgsn-system"
 * <p>
 * See line 548 in
 * epcCmnNmCli.yang
 *
 ...
 */
public class MmeSgsnSystem extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty MmeSgsnSystem object.
     */
    public MmeSgsnSystem() {
        super(Epc.NAMESPACE, "mme-sgsn-system");
    }
     ...
     */
    public MmeSgsnSystem clone() {
        return (MmeSgsnSystem)cloneContent(new MmeSgsnSystem());
    }
     ...
     */
    public MmeSgsnSystem cloneShallow() {
        return (MmeSgsnSystem)cloneShallowContent(new MmeSgsnSystem());
    }
