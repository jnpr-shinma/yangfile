/* 
 * @(#)TrackingAreaOper.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/serviceArea/tracking-area-oper"
 * <p>
 * See line 259 in
 * s1MasterCli.yang
 *
 ...
 */
public class TrackingAreaOper extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty TrackingAreaOper object.
     */
    public TrackingAreaOper() {
        super(Epc.NAMESPACE, "tracking-area-oper");
    }
     ...
     */
    public TrackingAreaOper clone() {
        return (TrackingAreaOper)cloneContent(new TrackingAreaOper());
    }
     ...
     */
    public TrackingAreaOper cloneShallow() {
        return (TrackingAreaOper)cloneShallowContent(new TrackingAreaOper());
    }
