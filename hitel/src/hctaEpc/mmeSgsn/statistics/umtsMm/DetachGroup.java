 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/umtsMm/detach-group"
 * <p>
 * See line 2076 in
 * oamPmServerCli.yang
 *
 ...
 */
public class DetachGroup extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty DetachGroup object.
     */
    public DetachGroup() {
        super(Epc.NAMESPACE, "detach-group");
    }
     ...
     */
    public DetachGroup clone() {
        return (DetachGroup)cloneContent(new DetachGroup());
    }
     ...
     */
    public DetachGroup cloneShallow() {
        return (DetachGroup)cloneShallowContent(new DetachGroup());
    }
