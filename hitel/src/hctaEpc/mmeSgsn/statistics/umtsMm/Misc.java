 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/umtsMm/misc"
 * <p>
 * See line 2129 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Misc extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Misc object.
     */
    public Misc() {
        super(Epc.NAMESPACE, "misc");
    }
     ...
     */
    public Misc clone() {
        return (Misc)cloneContent(new Misc());
    }
     ...
     */
    public Misc cloneShallow() {
        return (Misc)cloneShallowContent(new Misc());
    }
