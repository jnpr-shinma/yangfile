 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/umtsMm/attach"
 * <p>
 * See line 2050 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Attach extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Attach object.
     */
    public Attach() {
        super(Epc.NAMESPACE, "attach");
    }
     ...
     */
    public Attach clone() {
        return (Attach)cloneContent(new Attach());
    }
     ...
     */
    public Attach cloneShallow() {
        return (Attach)cloneShallowContent(new Attach());
    }
