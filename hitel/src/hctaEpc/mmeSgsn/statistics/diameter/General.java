 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/diameter/general"
 * <p>
 * See line 127 in
 * oamPmServerCli.yang
 *
 ...
 */
public class General extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty General object.
     */
    public General() {
        super(Epc.NAMESPACE, "general");
    }
    ...
    public General clone() {
        return (General)cloneContent(new General());
    }
     ...
     */
    public General cloneShallow() {
        return (General)cloneShallowContent(new General());
    }
