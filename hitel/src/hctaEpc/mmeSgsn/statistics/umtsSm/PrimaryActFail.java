/* 
 * @(#)PrimaryActFail.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/umtsSm/primaryActFail"
 * <p>
 * See line 2317 in
 * oamPmServerCli.yang
 *
 ...
 */
public class PrimaryActFail extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty PrimaryActFail object.
     */
    public PrimaryActFail() {
        super(Epc.NAMESPACE, "primaryActFail");
    }
     ...
     */
    public PrimaryActFail clone() {
        return (PrimaryActFail)cloneContent(new PrimaryActFail());
    }
     ...
     */
    public PrimaryActFail cloneShallow() {
        return (PrimaryActFail)cloneShallowContent(new PrimaryActFail());
    }
