 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/umtsSm/irauFail"
 * <p>
 * See line 2265 in
 * oamPmServerCli.yang
 *
 ...
 */
public class IrauFail extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty IrauFail object.
     */
    public IrauFail() {
        super(Epc.NAMESPACE, "irauFail");
    }
     ...
     */
    public IrauFail clone() {
        return (IrauFail)cloneContent(new IrauFail());
    }
     ...
     */
    public IrauFail cloneShallow() {
        return (IrauFail)cloneShallowContent(new IrauFail());
    }
