/* 
 * @(#)PriActGgsnFail.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/umtsSm/priActGgsnFail"
 * <p>
 * See line 2291 in
 * oamPmServerCli.yang
 *
 ...
 */
public class PriActGgsnFail extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty PriActGgsnFail object.
     */
    public PriActGgsnFail() {
        super(Epc.NAMESPACE, "priActGgsnFail");
    }
     ...
     */
    public PriActGgsnFail clone() {
        return (PriActGgsnFail)cloneContent(new PriActGgsnFail());
    }
     ...
     */
    public PriActGgsnFail cloneShallow() {
        return (PriActGgsnFail)cloneShallowContent(new PriActGgsnFail());
    }
