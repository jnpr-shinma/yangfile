/* 
 * @(#)SecActGgsnFail.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/umtsSm/secActGgsnFail"
 * <p>
 * See line 2343 in
 * oamPmServerCli.yang
 *
 ...
 */
public class SecActGgsnFail extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty SecActGgsnFail object.
     */
    public SecActGgsnFail() {
        super(Epc.NAMESPACE, "secActGgsnFail");
    }
     ...
     */
    public SecActGgsnFail clone() {
        return (SecActGgsnFail)cloneContent(new SecActGgsnFail());
    }
     ...
     */
    public SecActGgsnFail cloneShallow() {
        return (SecActGgsnFail)cloneShallowContent(new SecActGgsnFail());
    }
