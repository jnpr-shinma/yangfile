/* 
 * @(#)SecondaryAct.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/umtsSm/secondaryAct"
 * <p>
 * See line 2356 in
 * oamPmServerCli.yang
 *
 ...
 */
public class SecondaryAct extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty SecondaryAct object.
     */
    public SecondaryAct() {
        super(Epc.NAMESPACE, "secondaryAct");
    }
     ...
     */
    public SecondaryAct clone() {
        return (SecondaryAct)cloneContent(new SecondaryAct());
    }
     ...
     */
    public SecondaryAct cloneShallow() {
        return (SecondaryAct)cloneShallowContent(new SecondaryAct());
    }
