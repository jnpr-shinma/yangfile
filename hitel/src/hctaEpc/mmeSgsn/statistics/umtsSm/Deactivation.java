/* 
 * @(#)Deactivation.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/umtsSm/deactivation"
 * <p>
 * See line 2226 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Deactivation extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Deactivation object.
     */
    public Deactivation() {
        super(Epc.NAMESPACE, "deactivation");
    }
     ...
     */
    public Deactivation clone() {
        return (Deactivation)cloneContent(new Deactivation());
    }
     ...
     */
    public Deactivation cloneShallow() {
        return (Deactivation)cloneShallowContent(new Deactivation());
    }
