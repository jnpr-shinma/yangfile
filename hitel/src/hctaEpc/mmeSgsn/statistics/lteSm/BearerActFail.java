/* 
 * @(#)BearerActFail.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteSm/bearerActFail"
 * <p>
 * See line 1252 in
 * oamPmServerCli.yang
 *
 ...
 */
public class BearerActFail extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty BearerActFail object.
     */
    public BearerActFail() {
        super(Epc.NAMESPACE, "bearerActFail");
    }
     ...
     */
    public BearerActFail clone() {
        return (BearerActFail)cloneContent(new BearerActFail());
    }
     ...
     */
    public BearerActFail cloneShallow() {
        return (BearerActFail)cloneShallowContent(new BearerActFail());
    }
