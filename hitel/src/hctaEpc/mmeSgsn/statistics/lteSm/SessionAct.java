 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteSm/sessionAct"
 * <p>
 * See line 1330 in
 * oamPmServerCli.yang
 *
 ...
 */
public class SessionAct extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty SessionAct object.
     */
    public SessionAct() {
        super(Epc.NAMESPACE, "sessionAct");
    }
     ...
     */
    public SessionAct clone() {
        return (SessionAct)cloneContent(new SessionAct());
    }
     ...
     */
    public SessionAct cloneShallow() {
        return (SessionAct)cloneShallowContent(new SessionAct());
    }
