 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteSm/eRab"
 * <p>
 * See line 1278 in
 * oamPmServerCli.yang
 *
 ...
 */
public class ERab extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty ERab object.
     */
    public ERab() {
        super(Epc.NAMESPACE, "eRab");
    }
     ...
     */
    public ERab clone() {
        return (ERab)cloneContent(new ERab());
    }
     ...
     */
    public ERab cloneShallow() {
        return (ERab)cloneShallowContent(new ERab());
    }
