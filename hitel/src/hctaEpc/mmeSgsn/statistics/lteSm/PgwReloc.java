 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteSm/pgwReloc"
 * <p>
 * See line 1304 in
 * oamPmServerCli.yang
 *
 ...
 */
public class PgwReloc extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty PgwReloc object.
     */
    public PgwReloc() {
        super(Epc.NAMESPACE, "pgwReloc");
    }
     ...
     */
    public PgwReloc clone() {
        return (PgwReloc)cloneContent(new PgwReloc());
    }
     ...
     */
    public PgwReloc cloneShallow() {
        return (PgwReloc)cloneShallowContent(new PgwReloc());
    }
