/* 
 * @(#)SessionActFail.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteSm/sessionActFail"
 * <p>
 * See line 1343 in
 * oamPmServerCli.yang
 *
 ...
 */
public class SessionActFail extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty SessionActFail object.
     */
    public SessionActFail() {
        super(Epc.NAMESPACE, "sessionActFail");
    }
     ...
     */
    public SessionActFail clone() {
        return (SessionActFail)cloneContent(new SessionActFail());
    }
     ...
     */
    public SessionActFail cloneShallow() {
        return (SessionActFail)cloneShallowContent(new SessionActFail());
    }
