 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteSm/deact"
 * <p>
 * See line 1265 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Deact extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Deact object.
     */
    public Deact() {
        super(Epc.NAMESPACE, "deact");
    }
     ...
     */
    public Deact clone() {
        return (Deact)cloneContent(new Deact());
    }
     ...
     */
    public Deact cloneShallow() {
        return (Deact)cloneShallowContent(new Deact());
    }
