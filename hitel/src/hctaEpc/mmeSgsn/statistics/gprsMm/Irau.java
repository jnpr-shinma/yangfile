 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/gprsMm/irau"
 * <p>
 * See line 372 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Irau extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Irau object.
     */
    public Irau() {
        super(Epc.NAMESPACE, "irau");
    }
     ...
     */
    public Irau clone() {
        return (Irau)cloneContent(new Irau());
    }
     ...
     */
    public Irau cloneShallow() {
        return (Irau)cloneShallowContent(new Irau());
    }
