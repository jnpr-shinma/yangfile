 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/sc/uePurge"
 * <p>
 * See line 1702 in
 * oamPmServerCli.yang
 *
 ...
 */
public class UePurge extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty UePurge object.
     */
    public UePurge() {
        super(Epc.NAMESPACE, "uePurge");
    }
     ...
     */
    public UePurge clone() {
        return (UePurge)cloneContent(new UePurge());
    }
     ...
     */
    public UePurge cloneShallow() {
        return (UePurge)cloneShallowContent(new UePurge());
    }
