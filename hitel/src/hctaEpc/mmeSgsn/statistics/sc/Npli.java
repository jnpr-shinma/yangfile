 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/sc/npli"
 * <p>
 * See line 1663 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Npli extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Npli object.
     */
    public Npli() {
        super(Epc.NAMESPACE, "npli");
    }
     ...
     */
    public Npli clone() {
        return (Npli)cloneContent(new Npli());
    }
     ...
     */
    public Npli cloneShallow() {
        return (Npli)cloneShallowContent(new Npli());
    }
