 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/sc/loadControl"
 * <p>
 * See line 1650 in
 * oamPmServerCli.yang
 *
 ...
 */
public class LoadControl extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty LoadControl object.
     */
    public LoadControl() {
        super(Epc.NAMESPACE, "loadControl");
    }
    ...
    public LoadControl clone() {
        return (LoadControl)cloneContent(new LoadControl());
    }
     ...
     */
    public LoadControl cloneShallow() {
        return (LoadControl)cloneShallowContent(new LoadControl());
    }
