 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteMm/tau"
 * <p>
 * See line 1220 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Tau extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Tau object.
     */
    public Tau() {
        super(Epc.NAMESPACE, "tau");
    }
     ...
     */
    public Tau clone() {
        return (Tau)cloneContent(new Tau());
    }
     ...
     */
    public Tau cloneShallow() {
        return (Tau)cloneShallowContent(new Tau());
    }
