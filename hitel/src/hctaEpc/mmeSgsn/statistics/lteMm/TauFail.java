 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteMm/tauFail"
 * <p>
 * See line 1233 in
 * oamPmServerCli.yang
 *
 ...
 */
public class TauFail extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty TauFail object.
     */
    public TauFail() {
        super(Epc.NAMESPACE, "tauFail");
    }
     ...
     */
    public TauFail clone() {
        return (TauFail)cloneContent(new TauFail());
    }
     ...
     */
    public TauFail cloneShallow() {
        return (TauFail)cloneShallowContent(new TauFail());
    }
