 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteMm/itauFail"
 * <p>
 * See line 1142 in
 * oamPmServerCli.yang
 *
 ...
 */
public class ItauFail extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty ItauFail object.
     */
    public ItauFail() {
        super(Epc.NAMESPACE, "itauFail");
    }
     ...
     */
    public ItauFail clone() {
        return (ItauFail)cloneContent(new ItauFail());
    }
     ...
     */
    public ItauFail cloneShallow() {
        return (ItauFail)cloneShallowContent(new ItauFail());
    }
