/* 
 * @(#)ServiceRequest.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteMm/serviceRequest"
 * <p>
 * See line 1194 in
 * oamPmServerCli.yang
 *
 ...
 */
public class ServiceRequest extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty ServiceRequest object.
     */
    public ServiceRequest() {
        super(Epc.NAMESPACE, "serviceRequest");
    }
    ...
    public ServiceRequest clone() {
        return (ServiceRequest)cloneContent(new ServiceRequest());
    }
     ...
     */
    public ServiceRequest cloneShallow() {
        return (ServiceRequest)cloneShallowContent(new ServiceRequest());
    }
