 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteMm/paging"
 * <p>
 * See line 1155 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Paging extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Paging object.
     */
    public Paging() {
        super(Epc.NAMESPACE, "paging");
    }
     ...
     */
    public Paging clone() {
        return (Paging)cloneContent(new Paging());
    }
     ...
     */
    public Paging cloneShallow() {
        return (Paging)cloneShallowContent(new Paging());
    }
