 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteMm/itau"
 * <p>
 * See line 1129 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Itau extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Itau object.
     */
    public Itau() {
        super(Epc.NAMESPACE, "itau");
    }
     ...
     */
    public Itau clone() {
        return (Itau)cloneContent(new Itau());
    }
     ...
     */
    public Itau cloneShallow() {
        return (Itau)cloneShallowContent(new Itau());
    }
