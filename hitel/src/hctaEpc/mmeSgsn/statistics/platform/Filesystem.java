 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/platform/filesystem"
 * <p>
 * See line 1407 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Filesystem extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Filesystem object.
     */
    public Filesystem() {
        super(Epc.NAMESPACE, "filesystem");
    }
    ...
    public Filesystem clone() {
        return (Filesystem)cloneContent(new Filesystem());
    }
     ...
     */
    public Filesystem cloneShallow() {
        return (Filesystem)cloneShallowContent(new Filesystem());
    }
