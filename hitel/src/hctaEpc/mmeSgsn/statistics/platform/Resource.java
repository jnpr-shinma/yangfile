 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/platform/resource"
 * <p>
 * See line 1420 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Resource extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Resource object.
     */
    public Resource() {
        super(Epc.NAMESPACE, "resource");
    }
    ...
    public Resource clone() {
        return (Resource)cloneContent(new Resource());
    }
     ...
     */
    public Resource cloneShallow() {
        return (Resource)cloneShallowContent(new Resource());
    }
