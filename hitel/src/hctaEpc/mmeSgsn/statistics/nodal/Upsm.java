 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/nodal/upsm"
 * <p>
 * See line 1388 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Upsm extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Upsm object.
     */
    public Upsm() {
        super(Epc.NAMESPACE, "upsm");
    }
     ...
     */
    public Upsm clone() {
        return (Upsm)cloneContent(new Upsm());
    }
     ...
     */
    public Upsm cloneShallow() {
        return (Upsm)cloneShallowContent(new Upsm());
    }
