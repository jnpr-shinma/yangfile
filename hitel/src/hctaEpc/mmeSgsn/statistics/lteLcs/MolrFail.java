 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteLcs/molrFail"
 * <p>
 * See line 986 in
 * oamPmServerCli.yang
 *
 ...
 */
public class MolrFail extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty MolrFail object.
     */
    public MolrFail() {
        super(Epc.NAMESPACE, "molrFail");
    }
     ...
     */
    public MolrFail clone() {
        return (MolrFail)cloneContent(new MolrFail());
    }
     ...
     */
    public MolrFail cloneShallow() {
        return (MolrFail)cloneShallowContent(new MolrFail());
    }
