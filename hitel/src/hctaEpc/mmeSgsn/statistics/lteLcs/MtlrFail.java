 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteLcs/mtlrFail"
 * <p>
 * See line 973 in
 * oamPmServerCli.yang
 *
 ...
 */
public class MtlrFail extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty MtlrFail object.
     */
    public MtlrFail() {
        super(Epc.NAMESPACE, "mtlrFail");
    }
     ...
     */
    public MtlrFail clone() {
        return (MtlrFail)cloneContent(new MtlrFail());
    }
     ...
     */
    public MtlrFail cloneShallow() {
        return (MtlrFail)cloneShallowContent(new MtlrFail());
    }
