 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteLcs/ppnFail"
 * <p>
 * See line 1012 in
 * oamPmServerCli.yang
 *
 ...
 */
public class PpnFail extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty PpnFail object.
     */
    public PpnFail() {
        super(Epc.NAMESPACE, "ppnFail");
    }
     ...
     */
    public PpnFail clone() {
        return (PpnFail)cloneContent(new PpnFail());
    }
     ...
     */
    public PpnFail cloneShallow() {
        return (PpnFail)cloneShallowContent(new PpnFail());
    }
