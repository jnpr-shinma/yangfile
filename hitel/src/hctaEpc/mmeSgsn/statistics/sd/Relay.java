 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/sd/relay"
 * <p>
 * See line 1734 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Relay extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Relay object.
     */
    public Relay() {
        super(Epc.NAMESPACE, "relay");
    }
     ...
     */
    public Relay clone() {
        return (Relay)cloneContent(new Relay());
    }
     ...
     */
    public Relay cloneShallow() {
        return (Relay)cloneShallowContent(new Relay());
    }
