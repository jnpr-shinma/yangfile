 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/gprsSm/modify"
 * <p>
 * See line 547 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Modify extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Modify object.
     */
    public Modify() {
        super(Epc.NAMESPACE, "modify");
    }
     ...
     */
    public Modify clone() {
        return (Modify)cloneContent(new Modify());
    }
     ...
     */
    public Modify cloneShallow() {
        return (Modify)cloneShallowContent(new Modify());
    }
