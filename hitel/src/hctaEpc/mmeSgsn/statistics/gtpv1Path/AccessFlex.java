 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/gtpv1Path/accessFlex"
 * <p>
 * See line 728 in
 * oamPmServerCli.yang
 *
 ...
 */
public class AccessFlex extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty AccessFlex object.
     */
    public AccessFlex() {
        super(Epc.NAMESPACE, "accessFlex");
    }
     ...
     */
    public AccessFlex clone() {
        return (AccessFlex)cloneContent(new AccessFlex());
    }
     ...
     */
    public AccessFlex cloneShallow() {
        return (AccessFlex)cloneShallowContent(new AccessFlex());
    }
