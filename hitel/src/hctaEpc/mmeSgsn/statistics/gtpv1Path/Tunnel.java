 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/gtpv1Path/tunnel"
 * <p>
 * See line 767 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Tunnel extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Tunnel object.
     */
    public Tunnel() {
        super(Epc.NAMESPACE, "tunnel");
    }
     ...
     */
    public Tunnel clone() {
        return (Tunnel)cloneContent(new Tunnel());
    }
     ...
     */
    public Tunnel cloneShallow() {
        return (Tunnel)cloneShallowContent(new Tunnel());
    }
