 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/gtpv1Path/mobility"
 * <p>
 * See line 741 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Mobility extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Mobility object.
     */
    public Mobility() {
        super(Epc.NAMESPACE, "mobility");
    }
    ...
    public Mobility clone() {
        return (Mobility)cloneContent(new Mobility());
    }
     ...
     */
    public Mobility cloneShallow() {
        return (Mobility)cloneShallowContent(new Mobility());
    }
