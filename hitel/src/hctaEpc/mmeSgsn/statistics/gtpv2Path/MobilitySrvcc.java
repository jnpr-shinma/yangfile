/* 
 * @(#)MobilitySrvcc.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/gtpv2Path/mobilitySrvcc"
 * <p>
 * See line 870 in
 * oamPmServerCli.yang
 *
 ...
 */
public class MobilitySrvcc extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty MobilitySrvcc object.
     */
    public MobilitySrvcc() {
        super(Epc.NAMESPACE, "mobilitySrvcc");
    }
     ...
     */
    public MobilitySrvcc clone() {
        return (MobilitySrvcc)cloneContent(new MobilitySrvcc());
    }
     ...
     */
    public MobilitySrvcc cloneShallow() {
        return (MobilitySrvcc)cloneShallowContent(new MobilitySrvcc());
    }
