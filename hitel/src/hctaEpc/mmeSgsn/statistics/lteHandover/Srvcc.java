 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/lteHandover/srvcc"
 * <p>
 * See line 1057 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Srvcc extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Srvcc object.
     */
    public Srvcc() {
        super(Epc.NAMESPACE, "srvcc");
    }
     ...
     */
    public Srvcc clone() {
        return (Srvcc)cloneContent(new Srvcc());
    }
     ...
     */
    public Srvcc cloneShallow() {
        return (Srvcc)cloneShallowContent(new Srvcc());
    }
