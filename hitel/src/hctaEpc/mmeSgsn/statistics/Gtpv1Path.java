 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/gtpV1Path"
 * <p>
 * See line 724 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Gtpv1Path extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Gtpv1Path object.
     */
    public Gtpv1Path() {
        super(Epc.NAMESPACE, "gtpV1Path");
    }
     ...
     */
    public Gtpv1Path clone() {
        return (Gtpv1Path)cloneContent(new Gtpv1Path());
    }
     ...
     */
    public Gtpv1Path cloneShallow() {
        return (Gtpv1Path)cloneShallowContent(new Gtpv1Path());
    }
