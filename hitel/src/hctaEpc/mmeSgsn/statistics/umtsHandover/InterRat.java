 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/umtsHandover/interRat"
 * <p>
 * See line 2018 in
 * oamPmServerCli.yang
 *
 ...
 */
public class InterRat extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty InterRat object.
     */
    public InterRat() {
        super(Epc.NAMESPACE, "interRat");
    }
     ...
     */
    public InterRat clone() {
        return (InterRat)cloneContent(new InterRat());
    }
     ...
     */
    public InterRat cloneShallow() {
        return (InterRat)cloneShallowContent(new InterRat());
    }
