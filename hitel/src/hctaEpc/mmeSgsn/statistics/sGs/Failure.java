 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/sGs/failure"
 * <p>
 * See line 1767 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Failure extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Failure object.
     */
    public Failure() {
        super(Epc.NAMESPACE, "failure");
    }
    ...
    public Failure clone() {
        return (Failure)cloneContent(new Failure());
    }
     ...
     */
    public Failure cloneShallow() {
        return (Failure)cloneShallowContent(new Failure());
    }
