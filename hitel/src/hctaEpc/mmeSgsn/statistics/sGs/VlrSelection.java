/* 
 * @(#)VlrSelection.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/sGs/vlrSelection"
 * <p>
 * See line 1806 in
 * oamPmServerCli.yang
 *
 ...
 */
public class VlrSelection extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty VlrSelection object.
     */
    public VlrSelection() {
        super(Epc.NAMESPACE, "vlrSelection");
    }
     ...
     */
    public VlrSelection clone() {
        return (VlrSelection)cloneContent(new VlrSelection());
    }
     ...
     */
    public VlrSelection cloneShallow() {
        return (VlrSelection)cloneShallowContent(new VlrSelection());
    }
