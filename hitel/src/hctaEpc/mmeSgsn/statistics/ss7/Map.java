 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/ss7/map"
 * <p>
 * See line 1973 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Map extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Map object.
     */
    public Map() {
        super(Epc.NAMESPACE, "map");
    }
     ...
     */
    public Map clone() {
        return (Map)cloneContent(new Map());
    }
     ...
     */
    public Map cloneShallow() {
        return (Map)cloneShallowContent(new Map());
    }
