 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/ss7/cap"
 * <p>
 * See line 1947 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Cap extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Cap object.
     */
    public Cap() {
        super(Epc.NAMESPACE, "cap");
    }
     ...
     */
    public Cap clone() {
        return (Cap)cloneContent(new Cap());
    }
     ...
     */
    public Cap cloneShallow() {
        return (Cap)cloneShallowContent(new Cap());
    }
