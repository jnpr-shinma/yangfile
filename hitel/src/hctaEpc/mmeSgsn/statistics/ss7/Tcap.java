 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/ss7/tcap"
 * <p>
 * See line 1999 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Tcap extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Tcap object.
     */
    public Tcap() {
        super(Epc.NAMESPACE, "tcap");
    }
     ...
     */
    public Tcap clone() {
        return (Tcap)cloneContent(new Tcap());
    }
     ...
     */
    public Tcap cloneShallow() {
        return (Tcap)cloneShallowContent(new Tcap());
    }
