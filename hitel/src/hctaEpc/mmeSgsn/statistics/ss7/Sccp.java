 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/ss7/sccp"
 * <p>
 * See line 1986 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Sccp extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Sccp object.
     */
    public Sccp() {
        super(Epc.NAMESPACE, "sccp");
    }
     ...
     */
    public Sccp clone() {
        return (Sccp)cloneContent(new Sccp());
    }
     ...
     */
    public Sccp cloneShallow() {
        return (Sccp)cloneShallowContent(new Sccp());
    }
