 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/sgsnAcct/scdr"
 * <p>
 * See line 1851 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Scdr extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Scdr object.
     */
    public Scdr() {
        super(Epc.NAMESPACE, "scdr");
    }
     ...
     */
    public Scdr clone() {
        return (Scdr)cloneContent(new Scdr());
    }
     ...
     */
    public Scdr cloneShallow() {
        return (Scdr)cloneShallowContent(new Scdr());
    }
