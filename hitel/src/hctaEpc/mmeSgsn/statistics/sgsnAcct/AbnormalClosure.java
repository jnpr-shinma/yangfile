/* 
 * @(#)AbnormalClosure.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/sgsnAcct/abnormalClosure"
 * <p>
 * See line 1825 in
 * oamPmServerCli.yang
 *
 ...
 */
public class AbnormalClosure extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty AbnormalClosure object.
     */
    public AbnormalClosure() {
        super(Epc.NAMESPACE, "abnormalClosure");
    }
     ...
     */
    public AbnormalClosure clone() {
        return (AbnormalClosure)cloneContent(new AbnormalClosure());
    }
     ...
     */
    public AbnormalClosure cloneShallow() {
        return (AbnormalClosure)cloneShallowContent(new AbnormalClosure());
    }
