 ...
 * generated to "src/hctaEpc/mmeSgsn/statistics/sgsnAcct/mcdr"
 * <p>
 * See line 1838 in
 * oamPmServerCli.yang
 *
 ...
 */
public class Mcdr extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Mcdr object.
     */
    public Mcdr() {
        super(Epc.NAMESPACE, "mcdr");
    }
     ...
     */
    public Mcdr clone() {
        return (Mcdr)cloneContent(new Mcdr());
    }
     ...
     */
    public Mcdr cloneShallow() {
        return (Mcdr)cloneShallowContent(new Mcdr());
    }
