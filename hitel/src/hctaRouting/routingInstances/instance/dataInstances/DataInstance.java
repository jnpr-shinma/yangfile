/* 
 * @(#)DataInstance.java        1.0 09/12/14
 *
 ...
 * generated to "src/hctaRouting/routingInstances/instance/dataInstances/data-instance"
 * <p>
 * See line 253 in
 * hcta-routing.yang
 *
 ...
 */
public class DataInstance extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty DataInstance object.
     */
    public DataInstance() {
        super(Routing.NAMESPACE, "data-instance");
    }

    /**
     * Constructor for an initialized DataInstance object,
     * 
     * @param unitIdValue Key argument of child.
     */
    public DataInstance(YangUInt16 unitIdValue) throws JNCException {
        super(Routing.NAMESPACE, "data-instance");
     ...
     * @param unitIdValue Key argument of child.
     */
    public DataInstance(String unitIdValue) throws JNCException {
        super(Routing.NAMESPACE, "data-instance");
        Leaf unitId = new Leaf(Routing.NAMESPACE, "unit-id");
     ...
     * @param unitIdValue Key argument of child.
     */
    public DataInstance(int unitIdValue) throws JNCException {
        super(Routing.NAMESPACE, "data-instance");
        Leaf unitId = new Leaf(Routing.NAMESPACE, "unit-id");
        unitId.setValue(new YangUInt16(unitIdValue));
        insertChild(unitId, childrenNames());
    ...
    public DataInstance clone() {
        DataInstance copy;
        try {
            copy = new DataInstance(getUnitIdValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (DataInstance)cloneContent(copy);
    }
     ...
     */
    public DataInstance cloneShallow() {
        DataInstance copy;
        try {
            copy = new DataInstance(getUnitIdValue().toString());
        } catch (JNCException e) {
        ...
        return (DataInstance)cloneShallowContent(copy);
    }
